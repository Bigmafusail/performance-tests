...
# Создаём gRPC-клиент для UsersGatewayService и AccountsGatewayServiceStub
...
# 2. Открытие дебетового счёта на имя созданного пользователя
...
# 3. Выполняем операцию пополнения счета
